class SiteConfig
  cattr_accessor :race_types, :car_restrictions, :tyre_restrictions, :max_players, :mechanical, :game_mode, :penalties, :start_type, :type_fuel_dep, :grid_order, :boost, :shuffle_ratio, :grip_reduction
  # race regulations
